...
const JSON_PATH = 'c:\\Users\\ADMIN\\OneDrive\\Documents\\PERSONAL\\DEVELOPMENTS\\LKM\\JSON IMPORT\\17 Air.json';
const PARENT_CATEGORY = 'iPhone Accessories';
const CHILD_CATEGORY = 'iPhone 17 Air';
...
async function run() {
    console.log(`Starting ${CHILD_CATEGORY} accessories import...`);
