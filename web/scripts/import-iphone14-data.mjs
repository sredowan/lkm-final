...
const DATA_FILE = 'C:/Users/ADMIN/Downloads/scraped_data_ac01574e-e26a-41d4-8e41-1b921497d8bf.json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 14';

// Tags to extract from titles
const VALID_TAGS = [
    'phone case', 'screen protector', 'lens protector', 'charger', 'mount', 'accessory'
];
