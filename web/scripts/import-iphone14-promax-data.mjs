...
const JSON_FILE_PATH = 'C:/Users/ADMIN/Downloads/scraped_data_747fa366-a5e1-4ef1-b24a-443c908d836e.json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 14 Pro Max';
...
function generateMetaDescription(title, descriptionStr) {
    ...
    if (title) {
        return `Buy ${title}. High-quality accessory for iPhone 14 Pro Max. Correct format and premium quality.`;
    }
    return 'High-quality accessory for iPhone 14 Pro Max.';
}
