...
const JSON_FILE_PATH = 'C:/Users/ADMIN/Downloads/scraped_data_83d6394c-3e4d-4f5f-9c4d-989aada2276e.json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 15 Pro Max';
...
function generateMetaDescription(title, descriptionStr) {
    ...
    if (title) {
        return `Buy ${title}. High-quality accessory for iPhone 15 Pro Max. Correct format and premium quality.`;
    }
    return 'High-quality accessory for iPhone 15 Pro Max.';
}
