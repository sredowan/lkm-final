...
const JSON_FILE_PATH = 'C:/Users/ADMIN/Downloads/scraped_data_2bf0f350-e4b0-401d-9e65-b74dff961cf0.json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 16';
...
function generateMetaDescription(title, descriptionStr) {
    ...
    if (title) {
        return `Buy ${title}. High-quality accessory for iPhone 16.`;
    }
    return 'High-quality accessory for iPhone 16.';
}
