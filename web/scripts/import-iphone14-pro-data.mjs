...
const JSON_FILE_PATH = 'C:/Users/ADMIN/Downloads/scraped_data_f83e05a3-4149-4dcd-945c-13b77b079f75(1).json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 14 Pro';
...
function generateMetaDescription(title, descriptionStr) {
    ...
    if (title) {
        return `Buy ${title}. High-quality accessory for iPhone 14 Pro. Correct format and premium quality.`;
    }
    return 'High-quality accessory for iPhone 14 Pro.';
}
