...
const JSON_FILE_PATH = 'C:/Users/ADMIN/Downloads/scraped_data_9a0b0cdd-4f25-45fd-a648-159742d3aca1.json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 16 Plus';
...
function generateMetaDescription(title, descriptionStr) {
    ...
    if (title) {
        return `Buy ${title}. High-quality accessory for iPhone 16 Plus.`;
    }
    return 'High-quality accessory for iPhone 16 Plus.';
}
