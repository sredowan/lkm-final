...
const JSON_FILE_PATH = 'C:/Users/ADMIN/Downloads/scraped_data_e81e3d72-2b76-4948-acd2-95f3fa1f9d26.json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 15';
...
function generateMetaDescription(title, descriptionStr) {
    ...
    if (title) {
        return `Buy ${title}. High-quality accessory for iPhone 15. Correct format and premium quality.`;
    }
    return 'High-quality accessory for iPhone 15.';
}
