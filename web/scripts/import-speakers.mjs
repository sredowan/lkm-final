...
const JSON_FILE_PATH = path.join(__dirname, '../../JSON IMPORT/speaker.json');
const CATEGORY_NAME = 'Speakers';
const CATEGORY_SLUG = 'speakers';
...
function cleanPrice(priceDisplay) {
    ...
    // Handle formats like "Retail$199.95+GSTBusinessLogin to see price$199.95+GST"
    // We want the first dollar amount found
...
async function importProducts() {
    ...
    try {
        ...
        for (const item of products) {
            ...
            const price = priceRaw > 10 ? priceRaw - 10 : priceRaw; // Prevent negative
            ...
            try {
                ...
                // Filter duplicates and remove main
                ...
                console.log(`     > ${extraImages.length} extra images processed`);
