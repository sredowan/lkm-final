...
const JSON_FILE_PATH = 'C:/Users/ADMIN/Downloads/scraped_data_e17f44b7-bc93-4e45-8450-08b2c06b538a.json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 15 Pro';
...
function generateMetaDescription(title, descriptionStr) {
    ...
    if (title) {
        return `Buy ${title}. High-quality accessory for iPhone 15 Pro. Correct format and premium quality.`;
    }
    return 'High-quality accessory for iPhone 15 Pro.';
}
