...
const JSON_FILE_PATH = 'C:/Users/ADMIN/Downloads/scraped_data_5bd59a39-81ca-4c44-9132-7ad253c3b7d6.json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 16E';
...
function generateMetaDescription(title, descriptionStr) {
    ...
    if (title) {
        return `Buy ${title}. High-quality accessory for iPhone 16E.`;
    }
    return 'High-quality accessory for iPhone 16E.';
}
...
async function importProducts() {
    ...
    try {
        ...
        for (const item of products) {
            ...
            // New logic: decrease by $10 only if initial price > $15
            if (price > 15) {
                price = price - 10;
            }
