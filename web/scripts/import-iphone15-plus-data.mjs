...
const JSON_FILE_PATH = 'C:/Users/ADMIN/Downloads/scraped_data_b23c8c30-b565-4d38-8b18-133f89e6ff34.json';
const PARENT_CATEGORY_NAME = 'iPhone Accessories';
const SUB_CATEGORY_NAME = 'iPhone 15 Plus';
...
function generateMetaDescription(title, descriptionStr) {
    ...
    if (title) {
        return `Buy ${title}. High-quality accessory for iPhone 15 Plus. Correct format and premium quality.`;
    }
    return 'High-quality accessory for iPhone 15 Plus.';
}
