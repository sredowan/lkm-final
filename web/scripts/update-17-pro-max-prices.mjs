...
const JSON_PATH = 'C:\\Users\\ADMIN\\Downloads\\scraped_data_da1736e3-0e94-4e6f-837c-bba9b9f9d7ff.json';
const DEFAULT_PRICE = 35.00;

async function run() {
    console.log(`Starting price update from scraped_data_da1736e3-0e94-4e6f-837c-bba9b9f9d7ff.json...`);
