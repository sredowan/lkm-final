...
const JSON_PATH = 'C:\\Users\\ADMIN\\OneDrive\\Documents\\PERSONAL\\DEVELOPMENTS\\LKM\\JSON IMPORT\\New folder\\scraped_data_e585e26a-d4a4-4100-ad0e-a3b00af3df19.json';
const DEFAULT_PRICE = 35.00;

async function run() {
    console.log(`Starting price update from scraped_data_e585e26a-d4a4-4100-ad0e-a3b00af3df19.json...`);
