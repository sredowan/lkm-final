...
const JSON_PATH = 'C:\\Users\\ADMIN\\Downloads\\scraped_data_bbc18110-b693-4a7e-8638-b290114a2cb0.json';
const DEFAULT_PRICE = 35.00;

async function run() {
    console.log(`Starting price update from scraped_data_bbc18110-b693-4a7e-8638-b290114a2cb0.json (iPhone 17)...`);
