...
const JSON_PATH = 'C:\\Users\\ADMIN\\Downloads\\scraped_data_8c09214b-f26e-4545-9317-9e64ac16e73c.json';
const DEFAULT_PRICE = 35.00;

async function run() {
    console.log(`Starting price update from scraped_data_8c09214b-f26e-4545-9317-9e64ac16e73c.json (17 Pro)...`);
